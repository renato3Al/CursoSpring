...
import com.example.cursospring.domain.PagamentoComBoleto;
...
import com.example.cursospring.domain.enums.Perfil;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Categoria cat3 = new Categoria(null, "Esporte e Lazer");
		Categoria cat4 = new Categoria(null, "Eletrônicos");
		Categoria cat5 = new Categoria(null, "Ferramentas");
		Categoria cat6 = new Categoria(null, "Móveis e Decoração");
		...
		est1.getCiadades().addAll(Arrays.asList(c1));
		est2.getCiadades().addAll(Arrays.asList(c2, c3));

		estadoRepository.save(Arrays.asList(est1, est2));
		cidadeRepository.save(Arrays.asList(c1, c2, c3));
		
		Cliente cli1 = new Cliente(null, "Renato Sousa", "shinobby_19@hotmail.com", "36378912377", TipoCliente.PESSOAFISICA, passwordEncoder.encode("th3b3stof"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Maria Silva", "renato3.al@gmail.com", "78151920092", TipoCliente.PESSOAFISICA, passwordEncoder.encode("123"));
        cli2.getTelefones().addAll(Arrays.asList("985595443", "996543164"));
        cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220834",cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Coronel", "2867", null, "Centro", "60341641", cli2, c3);
